...
export const XIcon = ({ className, ...props }: React.ComponentProps<"svg">) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
export const V0Icon = ({
  ...
  <svg
    ...
    fill="currentColor"
    viewBox="0 0 147 70"
    className={cn("size-4.5 -translate-x-px shrink-0", className)}
    {...props}
  >
...
// Official Takumi mark used by takumi.kane.tw as its favicon/logo.
export const TakumiIcon = ({
  className,
  ...props
}: React.ComponentProps<"svg">) => (
  <svg
  ...
  >
    <defs>
      <linearGradient
        ...
        y2="128"
      >
        <stop offset="0" stopColor="#ffa944" />
      ...
      >
        ...
        <stop offset="1" stopColor="#d71d36" />
      </linearGradient>
    </defs>
    <path
      fill="url(#takumi-mark-a)"
...
// Official Forme square mark, matching the project favicon artwork.
export const FormeIcon = ({
  className,
  ...props
}: React.ComponentProps<"svg">) => (
  <svg
    ...
    {...props}
  >
    <rect x="6" y="6" width="52" height="52" rx="6" fill="#0f172a" />
    <rect x="16" y="16" width="32" height="4" rx="1" fill="#ffffff" />
    <rect x="16" y="26" width="22" height="4" rx="1" fill="#ffffff" />
    <rect x="16" y="36" width="4" height="12" rx="1" fill="#ffffff" />
  </svg>
);
