          ...
          <Page key={day.label} size="A4" style={styles.page}>
            ...
            <View style={styles.headerContainer}>
              <View style={{ flex: 1, paddingRight: 16 }}>
                ...
                <Text
                  style={{ color: theme.colors.mutedForeground, fontSize: 8.5 }}
                  noMargin
                >
                  {data.date}
            ...
            {data.tracks && data.tracks.length > 0 && (
              <View style={styles.legendContainer}>
                ...
                {data.tracks.map((track) => (
                  <View key={track.name} style={styles.legendItem}>
                    <View
                      style={[
                        styles.legendDot,
            ...
            <Section style={{ marginTop: 2 }}>
              {timeSlots.map((slot) => {
                ...
                return (
                  <View key={slot.time} style={styles.timeSlotRow}>
                    {/* Time Column */}
                                ...
                                {session.track && (
                                  ...
                                  >
                                    <Text
                                      style={{
                                        color:
                                          trackColor ?? theme.colors.foreground,
                                        fontSize: 7,
                                        fontWeight: "bold",
                                      }}
                                      noMargin
